...
#}
#
## Data source for Route 53 zone (optional, if you need to reference it)
#data "aws_route53_zone" "selected" {
  #name         = "yourdomain.com." # Replace with your domain, note the trailing dot
  #private_zone = false
#}
#
## Create ECS Cluster
...
#}
#
## HTTPS Listener using existing certificate
...
#}
#
## Optional: Route 53 record to point to the ALB
#resource "aws_route53_record" "alb" {
  #zone_id = data.aws_route53_zone.selected.zone_id
  #name    = "app.yourdomain.com" # Replace with your desired subdomain
  #type    = "A"
#
  #alias {
